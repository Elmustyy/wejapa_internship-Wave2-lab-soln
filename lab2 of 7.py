...
# creating and sortiñg a list of the dictionary's keys
sorted_keys = sorted(verse_dict)
print('sorted_keys:{}'.format(sorted_keys))
...
bonus_question_what_is_the_first_key_in_verse_dict = verse_dict['if']
print(verse_dict)